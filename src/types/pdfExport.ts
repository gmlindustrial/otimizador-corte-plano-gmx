...
export const DEFAULT_PDF_COLUMNS: PDFTableColumn[] = [
  { id: 'barra', header: 'Barra', width: 11, enabled: true },
  { id: 'tipo', header: 'Tipo', width: 12, enabled: true },
  { id: 'tag', header: 'TAG', width: 16, enabled: true },
  { id: 'fase', header: 'Fase', width: 10, enabled: true },
  { id: 'pos', header: 'Pos', width: 22, enabled: true },
  { id: 'qtd', header: 'Qtd', width: 9, enabled: true },
  { id: 'comp', header: 'Comp', width: 15, enabled: true },
  { id: 'peso', header: 'Peso', width: 14, enabled: true },
  { id: 'sobra', header: 'Sobra', width: 13, enabled: true },
