...
export const ValidationStep = ({ formData, setFormData, inspetoresQA }: ValidationStepProps) => {
  return (
        ...
        <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <div className="flex items-center space-x-3">
            <Checkbox
              ...
              className="w-6 h-6"
            />
            <Label htmlFor="validacaoQA" className="text-lg font-medium flex items-center gap-2">
              <CheckCircle className="w-5 h-5 text-green-600" />
              ✅ Tarefa validada pelo QA *
            </Label>
          </div>
          <p className="text-sm text-yellow-700 mt-2 ml-9">
            Esta validação é obrigatória para liberar o envio das sobras ao estoque.
          </p>
        </div>
      </CardContent>
    </Card>
